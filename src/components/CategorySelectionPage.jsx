...
export default function CategorySelectionPage({
  ...
  return (
    <div className="min-h-screen bg-slate-50/70 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      {/* Top Hero Banner */}
      <div className="text-center max-w-3xl mx-auto mb-12">
        <div className="inline-flex items-center gap-2 bg-emerald-100/80 text-emerald-900 px-4 py-1.5 rounded-full text-xs font-extrabold border border-emerald-200 mb-6 shadow-2xs">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight">
          Interactive Architecture & Mindmaps
        </h1>

        <p className="mt-4 text-sm sm:text-base text-slate-600 leading-relaxed font-medium">
          Select a category below to explore its mindmaps, block-by-block visual guides, code examples, API references, and best practices.
        </p>
      ...
      {/* Category Cards Grid (4 Cards Only) */}
